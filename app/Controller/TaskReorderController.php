    ...
    public function reorderColumn()
    {
        ...
        switch ($sort) {
            ...
            case 'due-date':
                ...
                break;
            case 'closed-date':
                $this->taskReorderModel->reorderByClosedDate($project['id'], $swimlaneID, $columnID, $direction);
                break;
            case 'moved-date':
                $this->taskReorderModel->reorderByMovedDate($project['id'], $swimlaneID, $columnID, $direction);
                break;
        }
